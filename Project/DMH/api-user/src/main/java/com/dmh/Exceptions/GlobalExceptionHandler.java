...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> handleInvalidCredentialsException(UserInvalidCredentialsException ex) {
        return ResponseEntity
    ...
    public ResponseEntity<?> handleInternalServerErrorException(UserInternalServerErrorException ex) {
        return ResponseEntity
